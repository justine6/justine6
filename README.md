...
My work focuses on platform architecture, DevSecOps automation, cloud security, CI/CD systems, observability, and platform operations. I build platforms that help teams deploy, operate, and scale systems reliably in the cloud.

I maintain the **JLT Platform** as a live platform engineering environment where I design platform architecture, implement automation, enforce access control, and document operational runbooks.
